...
#ifndef Max72xxPanel2_h
#define Max72xxPanel2_h
...
class Max72xxPanel2 : public Adafruit_GFX {
...
public:
   ...
   */
  Max72xxPanel2(byte csPin, byte hDisplays=1, byte vDisplays=1);

  /*
   * return the following 8 pixels as a byte
   * 
   */

  byte readByte(uint16_t x, uint16_t y);
